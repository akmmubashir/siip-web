...
export function SignalsSection() {
  return <section className="px-6 py-24 md:px-12 lg:px-24 border-b border-zinc-900">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16">
        ...
        delay: 0.2
          ...
          }].map((item, i) => <li key={i} className="group cursor-pointer">
                <Link href={`/signals/${item.slug}`} className="flex items-baseline justify-between border-b border-zinc-900 pb-4 group-hover:border-zinc-700 transition-colors">
