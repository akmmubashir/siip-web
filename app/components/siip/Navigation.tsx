    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center">
        ...
        <div className="flex items-center gap-6 md:gap-8">
          <Link
            href="/doctrine"
            className={`text-xs font-mono transition-colors ${currentPath === "/doctrine" ? "text-white" : "text-zinc-500 hover:text-zinc-300"}`}
          >
            DOCTRINE
          </Link>
          <Link
            href="/signals"
            className={`text-xs font-mono transition-colors ${currentPath === "/signals" ? "text-white" : "text-zinc-500 hover:text-zinc-300"}`}
          >
            SIGNALS
          </Link>
